 ...
 */
public class UpdateGenerateIntention extends StatementGenerateIntention {
    ...
    protected Statement generateStatement(@NotNull Mapper mapperDom) {
        return mapperDom.addUpdate(mapperDom.getUpdates().size());
    }
    ...
    public String getFamilyName() {
        return "Generate Mapper Update Statement";
    }
}
